        ...
        <div className="text-gray-500 p-5 text-sm border-r
         border-gray-900 overflow-y-scroll h-screen scrollbar-hide">
            <div className="space-y-3" >
                ...
                <button  className="flex items--center direction:column  space-x-2
                 hover:text-white"
                 onClick={()=> signOut()} >
                ...
                <button className="flex items--center direction:column  space-x-2 hover:text-white" >
                ...
                <button className="flex items--center direction:column  space-x-2 hover:text-white" >
                    <PlusCircleIcon className="h-3 5-5" />
                    <p>Create Playlist</p> 
                </button>
